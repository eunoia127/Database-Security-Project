...
INSERT INTO SYSTEM.COVERAGE_CD (COVERAGE_CODE, SUB_COVERAGE_CODE, COVERAGE_NAME, COVERAGE_DESCRIPTION, CREATED_USER_ID, UPDATED_USER_ID)
VALUES ('MP', 'MP', 'Medical Payments', 'or the health costs of client and the passengers of the client’s vehicle, injured in an accident, regardless of whose fault', 'admin', 'admin');
